...
public class LagrangeCoefficientsPojo {
  public final Map<String, ElementModQ> coefficients; // guardian id to lagrange coefficient

  public LagrangeCoefficientsPojo(Map<String, ElementModQ> coefficients) {
  ...
  static class Pojo {
    public final Map<String, ElementModQ> coefficients;

    public Pojo(Map<String, ElementModQ> coefficients) {
      this.coefficients = coefficients;
    }
  }
